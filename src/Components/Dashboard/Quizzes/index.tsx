      ...
      <div className="mt-[70px] px-[0px] lg:px-[80px]">
        ...
        <div>
          <div>
            ...
            <input type="number" min="0" className="block w-[200px] border border-[#E2E4E2] py-2 px-3 rounded-lg my-2"/>
          </div>

          <div className="my-6">
            <span>
              What pages do you want to test your knowledge in?{" "}
              <Link to='preview'><span className="font-bold text-orange underline">Preview PDF</span></Link>
            </span>
          </div>

          <div className=" flex gap-4">
            <div>
              <input type="number" min='0' className="block w-[100px] border border-[#E2E4E2] py-1 px-3 rounded-lg"/>
          ...
          <button className="w-[180px] bg-orange text-white rounded-lg py-2 my-6">Generate Quiz</button>
        </div>
      </div>
    </div>
  );
